...
DEFAULT_PACKAGES:=base-files libc libgcc busybox dropbear mtd uci opkg netifd fstools default-settings luci uclient-fetch logd urandom-seed urngd luci-app-ssr-plus wget
# For nas targets
